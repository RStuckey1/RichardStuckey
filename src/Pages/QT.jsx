    ...
    return (
        <>
            <div className="flowMeters">
                ...
                <p>These pictures I took myself from infected animals. When aquarium systems have an infection of flukes, it normally is the end to that aquarium. However, my persistentance paid off and I was able to cure this system of flukes.(It only took 1.5 years)</p>
                <div className="flowPicBox">
